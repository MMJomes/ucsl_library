...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action={{ route('backend.sidebusiness.store') }} method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                @if ($errors->any())
                        ...
                        <div class="media photo center">
                            ...
                            <div class="media-body">
                                ...
                                <button type="button" class="btn btn-default-dark" id="btn-upload-photo">Upload
                                    Photo</button>
                                <input type="file" name="business_images" required id="filePhoto" class="sr-only" accept="image/*">
                            </div>
                        </div>
                        <div class="body mt-5">
