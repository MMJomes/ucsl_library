                        ...
                        <div class="media photo center">
                            ...
                            <div class="media-body">
                                ...
                                <button type="button" class="btn btn-default-dark" id="btn-upload-photo">Upload
                                    Photo</button>
                                <input type="file" name="business_images" id="filePhoto" class="sr-only" accept="image/*">
                            </div>
                        </div>
                        <div class="body mt-5">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <select class="selectpicker form-control" data-style="form-control btn-secondary"
                                        ...
                                        @foreach ($businessTypes as $businessType)
                                            <option value="{{ $businessType->id }}" {{$sidebusiness->biz_type_tbl_id == $businessType->id ? 'selected' : ''}} >
                                                {{ $businessType->name }}
                                            </option>
                                        @endforeach
                                    </select>
