...
@section('content')
    <div class="row page-titles">
        ...
        <div class="col-md-6">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('student.stdclass.index') }}"> {{ __('message.categorylist') }}</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action={{ route('student.stdclass.store') }} method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                @if ($errors->any())
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="studentclass" id="studentclass"
                                            placeholder="Class Name" value="{{ old('studentclass') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5">
                                <button type="submit" class="btn btn-info"><i class="fa fa-save"></i> {{__('message.save')}}</button>
                                <a href="{{ route('student.stdclass.index') }}" class="btn btn-danger"><i
