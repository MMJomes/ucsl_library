...
<div class="row page-titles">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action={{ route('stduent.stduents.update',[$stduent->slug]) }} method="POST" enctype="multipart/form-data">
                        @csrf
                        {{csrf_field()}}
                        @method('PUT')
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="{{ __('message.name') }}" value="{{ old('name',$stduent->name) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <h5>{{ 'Select Class' }} </h5>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" name="phoneNo" id="phoneNo"
                                            placeholder="Enter Phone Number" value="{{ old('phoneNo',$stduent->phoneNo) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="Address" class="form-control" name="Address" id="Address"
                                            placeholder="Enter Your Address" value="{{ old('Address',$stduent->Address) }}">
                                    </div>
                                </div>
                            </div>
