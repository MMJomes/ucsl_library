...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <p action={{ route('stduent.stduents.update', [$stduent->slug]) }} method="POST"
                        ...
                        <div class="body mt-5">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label for="rollint"> Total Number of Rent Books Count </label>
                                        <input type="tel" class="form-control" name="phoneNo" id="phoneNo"
                                            placeholder="Enter Phone Number"
                                            value="{{ old('phoneNo', $stduent->totalNoOfBooks) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label for="address">Total Number of Return Books Count</label>
                                        <input type="Address" class="form-control" name="Address" id="Address"
                                            placeholder="Enter Your Address"
                                            value="{{ old('Address', $stduent->totalNoOfreturn  ) }}">
                                    </div>
                                </div>
                            </div>
