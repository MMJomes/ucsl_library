                        ...
                        <table id="dataTable" class="display nowrap table table-hover table-striped table-bordered"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    @canany(['stduent.approve', 'stduent.mass_approve'])
                                        <th>Status</th>
                                    @endcanany
                                    @canany(['stduent.edit', 'stduent.delete'])
            ...
            $.ajax({
                ...
                $('#dataTable').DataTable({
                    ...
                    columns: [{
                        ...
                        @endcanany
                        @canany(['stduent.edit', 'stduent.delete', 'stduent.show'])
                            {
                                orderable: false,
                                "render": function(data, type, full, meta) {
                                    var editURL =
